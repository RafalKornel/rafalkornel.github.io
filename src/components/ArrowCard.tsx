...
export default function ArrowCard({ entry, pill }: Props) {
  return (
    <a
      ...
      class="group p-4 gap-3 flex items-center border rounded-lg hover:bg-main/5 hover:dark:bg-white/10 border-black/15 dark:border-white/20 transition-colors duration-300 ease-in-out"
    >
